 ...
 */
class modTemplateVarInputRenderMmlCheckboxes extends modTemplateVarInputRender {
    public function getTemplate() {
        
        $path = 'components/migxmultilang/';
        $corePath = $this->modx->getOption('mml.core_path', null, $this->modx->getOption('core_path') . $path);
        return $corePath . 'elements/tv/mml_checkboxes.tpl';        
    }
...
return 'modTemplateVarInputRenderMmlCheckboxes';